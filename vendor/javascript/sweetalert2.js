...
/**
   ...
   * @param {HTMLElement} popup
   * @param {SweetAlertOptions} innerParams
   */const handlePopupAnimation=(e,t,n)=>{const s=getContainer();const a=hasCssAnimation(t);typeof n.willClose==="function"&&n.willClose(t);o.eventEmitter.emit("willClose",t);a?animatePopup(e,t,s,n.returnFocus,n.didClose):removePopupAndResetState(e,s,n.returnFocus,n.didClose)};
/**
   * @param {SweetAlert} instance
   * @param {HTMLElement} popup
   * @param {HTMLElement} container
   * @param {boolean} returnFocus
   * @param {Function} didClose
   */const animatePopup=(e,t,n,s,a)=>{o.swalCloseEventFinishedCallback=removePopupAndResetState.bind(null,e,n,s,a);const swalCloseAnimationFinished=function(e){if(e.target===t){o.swalCloseEventFinishedCallback();delete o.swalCloseEventFinishedCallback;t.removeEventListener("animationend",swalCloseAnimationFinished);t.removeEventListener("transitionend",swalCloseAnimationFinished)}};t.addEventListener("animationend",swalCloseAnimationFinished);t.addEventListener("transitionend",swalCloseAnimationFinished)};
/**
   * @param {SweetAlert} instance
   * @param {Function} didClose
