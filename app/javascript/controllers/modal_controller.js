...
export default class extends Controller {
  ...
  connect() {
    document.getElementById(`modal-${this.element.dataset.modalTriggerId}-wrapper`).addEventListener('click', (event) => this.closeModal(event, this.element.dataset.modalTriggerId))
